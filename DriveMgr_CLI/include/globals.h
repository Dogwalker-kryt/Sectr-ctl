...
namespace Globals{
    ...
    extern std::vector<scf::str512> g_last_drives;
    ...
    extern scf::str1024 g_config_src_path;
    ...
    // === version ===
    extern scf::str32 version;
    extern std::string version_std_str;
}